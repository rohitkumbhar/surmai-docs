  ...
  transformHead: ({ pageData }) => {
    ...
    head.push([
      "meta",
      {
        name: "description",
        content:
          "Surmai is a personal/family travel organizer. It allow collaborative planning between multiple people, easy access to all the necessary artifacts and keeps the data private.",
      },
    ]);
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: "Managing Users",
            link: "/documentation/configuration/managing-users",
          },
          {
            text: "SMTP Settings",
            link: "/documentation/configuration/setting-up-email",
          },
          {
            text: "Datasets",
            link: "/documentation/configuration/loading-datasets",
          },
          {
            text: "Integrations",
      ...
      },
      {
        ...
        items: [
          {
            text: "Managing Trips",
            link: "/documentation/usage/managing-trips",
          },
          {
            text: "Collaboration",
            link: "/documentation/usage/collaborating-on-a-trip",
          },
          {
            text: "Offline Access",
            link: "/documentation/usage/offline-access",
          },
          {
            text: "Calendar Integration",
            link: "/documentation/usage/calendar-integration",
          },
          {
            text: "Expense Tracking",
            link: "/documentation/usage/expense-tracking",
          },
          {
            text: "Import/Export",
            link: "/documentation/usage/import-export-trip",
          },
